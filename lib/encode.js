...
(function() {
  var encode, encode_json, encode_json_obj, encode_mpack, purepack;

  purepack = require('purepack');

  exports.encode = encode = function(_arg) {
    var encoding, json, mpack, obj;
    obj = _arg.obj, json = _arg.json, mpack = _arg.mpack, encoding = _arg.encoding;
    if (json) {
      json = true;
    } else if (mpack) {
      json = false;
